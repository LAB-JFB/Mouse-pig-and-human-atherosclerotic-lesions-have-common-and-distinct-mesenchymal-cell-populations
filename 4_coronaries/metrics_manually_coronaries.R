# ============================================================================
# Integration quality metrics for coronary arteries (30 method-homology combos)
# Metrics: kBET, PC Regression, LISI (iLISI + cLISI), ARI, NMI, cASW, bASW
# Species: pig (RCA) + human (Wirka coronary)
# Adapted from: github.com/MillerLab-CPHG/Human_athero_scRNA_meta
# ============================================================================

setwd("/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations")
...
# --- Load all 30 integrated coronary datasets ---
all_datasets <- readRDS("/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/all_datasets_ALL.rds")
...
embeddings_dir = "/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/embeddings/"
metadata_dir = "/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/metadata/"
...
saveRDS(my_kbet_result,
        "/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/kBET_rejection_rates_df.rds")

# --- Plot kBET rejection rate curves ---
my_kbet_result <- readRDS("/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/kBET_rejection_rates_df.rds")
...
pcr_list <- readRDS("/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/pcr_list.rds")
...
r2var_plot
ggsave("/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/r2var_PC_regression_plot.pdf",
...
saveRDS(merged_lisi_df,
        "/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/LISI_scores_per_cell.rds")

# --- Plot iLISI ---
merged_lisi_df <- readRDS("/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/LISI_scores_per_cell.rds")
...
mean_ilisi_scores = merged_lisi_df %>%
  ...
  scale_fill_manual(values= my_col) +  theme(aspect.ratio = 0.6,
                                             ...
                                             axis.text.x = element_text(angle = 90, vjust=0.5,
                                                                        hjust=1, size = 10))
mean_ilisi_scores
ggsave(file="/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/integration_mean_iLISI_scores.pdf",
...
mean_clisi_scores = merged_lisi_df %>%
  ...
  scale_fill_manual(values= my_col) +  theme(aspect.ratio = 0.6,
                                             ...
                                             axis.text.x = element_text(angle = 90, vjust=0.5,
                                                                        hjust=1, size = 10))
mean_clisi_scores
ggsave(file="/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/integration_mean_cLISI_scores.pdf",
...
saveRDS(ARI_list, '/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/ARI_smc_phenotypes.rds')

# --- Plot ARI ---
ARI_list <- readRDS("/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/ARI_smc_phenotypes.rds")
...
ggsave(file="/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/integration_ARI_scores.pdf",
...
saveRDS(NMI_list, '/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/NMI_smc_phenotypes.rds')

# --- Plot NMI ---
NMI_list <- readRDS("/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/NMI_smc_phenotypes.rds")
...
ggsave(file="/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/integration_NMI_scores.pdf",
...
saveRDS(cASW_scores_list, "/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/cASW_scores_list.rds")
...
ggsave(file="/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/cASW_plot.pdf",
...
saveRDS(bASW_scores_list, "/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/bASW_scores_list.rds")
...
ggsave(file="/faststorage/project/THOR/diana/integration_pigs_with_WT/integrated_pig_mice_hum/closer/more_closer/SMC/coronaries/after_bengal/all_integrations/bASW_plot.pdf",
       plot = res_sil_scores_plot, width = 3, height = 3, scale = 3)
